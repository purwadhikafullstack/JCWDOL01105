...
// const getTenantProperty = async (req, res, next) => {
//   try {
//     const userId = req.user.id;
//     const tenantId = await getTenantId(userId);
//     const properties = await property.find({ userRef: tenantId });
//     res.status(200).json(properties);
//   } catch (error) {
//     next(error);
//     console.error('Error cannot get Tenant property', error);
//   }
// };
...
//       where: { id: propertyId, userRef: userId },
//     });
...
//     }
//   } catch (error) {
//     throw new Error('Error getting tenant Id from database');
//   }
// };
